...
@.str.2 = private unnamed_addr constant [23 x i8] c"Argument size mismatch\00", align 1
...
@.str.15 = private unnamed_addr constant [41 x i8] c"Invalid type to perform logical negation\00", align 1
@.str.16 = private unnamed_addr constant [36 x i8] c"Invalid type to perform logical AND\00", align 1
@.str.17 = private unnamed_addr constant [35 x i8] c"Invalid type to perform logical OR\00", align 1
...
@.str.22 = private unnamed_addr constant [20 x i8] c"Not implemented yet\00", align 1
...
6:                                                ; preds = %4
  ...
  %8 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str) #13
...
5:                                                ; preds = %3
  ...
  %7 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str) #13
  tail call void @abort() #14
  unreachable
...
7:                                                ; preds = %3
  ...
  %9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3) #13, !noalias !19
...
10:                                               ; preds = %3, %3
  %11 = and i64 %5, 32768
  %12 = icmp eq i64 %11, 0
  %13 = load i64, ptr %2, align 8, !tbaa !17, !noalias !19
  %14 = and i64 %5, 32767
...
17:                                               ; preds = %15
  %18 = load ptr, ptr @stderr, align 8, !tbaa !12, !noalias !19
  %19 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %18, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #13, !noalias !19
  tail call void @abort() #14, !noalias !19
  unreachable

20:                                               ; preds = %10
  %21 = icmp ult i64 %13, %14
  br i1 %21, label %22, label %25, !prof !22

22:                                               ; preds = %20
  %23 = load ptr, ptr @stderr, align 8, !tbaa !12, !noalias !19
  %24 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %23, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #13, !noalias !19
  tail call void @abort() #14, !noalias !19
  unreachable
...
25:                                               ; preds = %20, %15
  ...
  %27 = load ptr, ptr %26, align 8, !tbaa !10, !noalias !19
  %28 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %29 = load ptr, ptr %28, align 8, !tbaa !10, !noalias !19
  call void %27(ptr noundef nonnull align 8 %4, ptr noundef nonnull %2, ptr noundef %29)
  %30 = load <2 x i64>, ptr %4, align 16, !tbaa !10
  store <2 x i64> %30, ptr %0, align 8, !tbaa !10
  %31 = getelementptr inbounds nuw i8, ptr %4, i64 16
  %32 = load i64, ptr %31, align 16, !tbaa !10
...
4:                                                ; preds = %1
  ...
  %6 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #13
  tail call void @abort() #14
  unreachable

7:                                                ; preds = %1
  %8 = getelementptr inbounds nuw i8, ptr %0, i64 8
  %9 = load i8, ptr %8, align 8, !tbaa !10, !range !23, !noundef !24
...
11:                                               ; preds = %8
  ...
  %13 = load i64, ptr %12, align 8, !tbaa !10, !noalias !25
  %14 = getelementptr inbounds nuw i8, ptr %1, i64 40
  %15 = load i64, ptr %14, align 8, !tbaa !10, !noalias !25
...
19:                                               ; preds = %17
  %20 = load i64, ptr %5, align 8, !tbaa !5, !noalias !25
  br label %21
...
25:                                               ; preds = %21
  ...
  %33 = load double, ptr %32, align 8, !noalias !25
...
39:                                               ; preds = %21, %17
  %40 = load ptr, ptr @stderr, align 8, !tbaa !12, !noalias !25
  %41 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %40, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.5) #13, !noalias !25
...
39:                                               ; preds = %21, %17
  ...
  %41 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %40, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.9) #13, !noalias !28
...
39:                                               ; preds = %21, %17
  ...
  %41 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %40, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.10) #13, !noalias !31
...
13:                                               ; preds = %8, %3
  ...
  %15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.12) #13, !noalias !34
...
24:                                               ; preds = %16
  ...
  %26 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %25, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.11) #13, !noalias !34
  tail call void @abort() #14, !noalias !34
  unreachable
...
27:                                               ; preds = %16
  ...
  %30 = load double, ptr %29, align 8, !noalias !34
...
38:                                               ; preds = %21, %17
  ...
  %40 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %39, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.13) #13, !noalias !37
...
38:                                               ; preds = %21, %17
  ...
  %40 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %39, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.13) #13, !noalias !40
...
38:                                               ; preds = %21, %17
  ...
  %40 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %39, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.13) #13, !noalias !43
...
38:                                               ; preds = %21, %17
  ...
  %40 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %39, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.13) #13, !noalias !46
...
46:                                               ; preds = %20, %17, %37
  ...
  %48 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %47, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.14) #13, !noalias !49
...
7:                                                ; preds = %3
  ...
  %9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.15) #13, !noalias !52
...
19:                                               ; preds = %7, %3
  ...
  %21 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.16) #13, !noalias !55
...
19:                                               ; preds = %7, %3
  ...
  %21 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.17) #13, !noalias !58
...
6:                                                ; preds = %3
  ...
  %10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.18, i64 noundef %9) #15
  br label %26
...
11:                                               ; preds = %3
  ...
  %15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %12, ptr noundef nonnull @.str.19, double noundef %14) #15
  br label %26
...
23:                                               ; preds = %3
  ...
  %25 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %24, ptr noundef nonnull @.str.8, ptr noundef nonnull @.str.22) #13
  tail call void @abort() #14
  unreachable
