...
$_ZN7chirart11unreachableEPKc = comdat any

@.str = private unnamed_addr constant [16 x i8] c"Invalid Var tag\00", align 1
...
6:                                                ; preds = %4
  ...
  %8 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2) #10
...
28:                                               ; preds = %26
  ...
  %30 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %29, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str) #10
  tail call void @abort() #11
  unreachable
...
5:                                                ; preds = %1
  ...
  %7 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.3) #10
  tail call void @abort() #11
  unreachable
...
4:                                                ; preds = %1
  ...
  %6 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.4) #10
  tail call void @abort() #11
  unreachable
...
define dso_local void @chirart_add(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2) local_unnamed_addr #4 {
...
9:                                                ; preds = %3
  tail call void @_ZN7chirart11unreachableEPKc(ptr noundef nonnull @.str.5) #12, !noalias !19
  unreachable

10:                                               ; preds = %3
  %11 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %12 = load i64, ptr %11, align 8, !tbaa !10, !noalias !19
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local void @chirart_subtract(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2) local_unnamed_addr #4 {
...
9:                                                ; preds = %3
  tail call void @_ZN7chirart11unreachableEPKc(ptr noundef nonnull @.str.5) #12, !noalias !22
  unreachable

10:                                               ; preds = %3
  %11 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %12 = load i64, ptr %11, align 8, !tbaa !10, !noalias !22
  %13 = getelementptr inbounds nuw i8, ptr %2, i64 8
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local void @chirart_lt(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2) local_unnamed_addr #4 {
...
9:                                                ; preds = %3
  tail call void @_ZN7chirart11unreachableEPKc(ptr noundef nonnull @.str.5) #12, !noalias !25
  unreachable

10:                                               ; preds = %3
  %11 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %12 = load i64, ptr %11, align 8, !tbaa !10, !noalias !25
  %13 = getelementptr inbounds nuw i8, ptr %2, i64 8
  ...
  store i8 %16, ptr %17, align 8, !tbaa !10
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define dso_local void @chirart_display(ptr nocapture noundef writeonly %0, ptr nocapture noundef readonly %1) local_unnamed_addr #4 {
  %3 = load i64, ptr %1, align 8, !tbaa !5
  %4 = icmp eq i64 %3, 1
  br i1 %4, label %6, label %5

5:                                                ; preds = %2
  tail call void @_ZN7chirart11unreachableEPKc(ptr noundef nonnull @.str.5) #12
  unreachable
...
6:                                                ; preds = %2
  ...
  %10 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.8, i64 noundef %9) #13
  store i64 0, ptr %0, align 8, !tbaa !5
  ret void
}
...
declare void @chiracg_main(ptr noundef, ptr noundef) local_unnamed_addr #6
...
define linkonce_odr dso_local void @_ZN7chirart11unreachableEPKc(ptr noundef %0) local_unnamed_addr #9 comdat {
  %2 = load ptr, ptr @stderr, align 8, !tbaa !12
  %3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef nonnull @.str.7, ptr noundef %0) #10
  tail call void @abort() #11
  unreachable
}
